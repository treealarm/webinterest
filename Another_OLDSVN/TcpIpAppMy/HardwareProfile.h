...
//	#define WF_SPI_IF			(IFS0bits.SPI1IF)
	...
	#define LED_IO				(LATCbits.LATC2)

	#define LED0_TRIS			(TRISEbits.TRISE3)	//4427 out 3 on main board			
	#define LED0_IO				(LATEbits.LATE3)
	#define LED1_TRIS			(TRISEbits.TRISE4)	//4427 out 2 on main board
	#define LED1_IO				(LATEbits.LATE4)

	#define LED2_TRIS			(TRISEbits.TRISE5)	//4427 out 1 on ext board
	#define LED2_IO				(LATEbits.LATE5)
	#define LED3_TRIS			(TRISDbits.TRISD0)	//4427 out 2 on ext board
	#define LED3_IO				(LATDbits.LATD0)

	#define LED4_TRIS			(TRISDbits.TRISD1) 
	#define LED4_IO				(LATDbits.LATD1)//M1.5
	#define LED5_TRIS			(TRISDbits.TRISD2)	
	#define LED5_IO				(LATDbits.LATD2)//M1.6
	#define LED6_TRIS			(TRISBbits.TRISB4)
	#define LED6_IO				(LATBbits.LATB4)//M1.7
	#define LED7_TRIS			(TRISBbits.TRISB5)
	#define LED7_IO				(LATBbits.LATB5)//M1.8
	#define LED_GET()			(LED_IO)
	#define LED_PUT(a)			(LED_IO = (a))
	

	#define BUTTON0_TRIS		(TRISBbits.TRISB0)
	#define	BUTTON0_IO			(PORTBbits.RB0)//For Setting reset P2.1 on ext board
	#define BUTTON1_TRIS		(TRISEbits.TRISE0)
	#define	BUTTON1_IO			(PORTEbits.RE0)//P2.2 on ext board
	#define BUTTON2_TRIS		(TRISGbits.TRISG4)
	#define	BUTTON2_IO			(PORTGbits.RG4)//M2.1 on ext Board
	#define BUTTON3_TRIS	(TRISEbits.TRISE2)				// No BUTTON3 on this board
	#define	BUTTON3_IO		(PORTEbits.RE2) //M2.8 on ext Board

	#define DATA0_TRIS		(TRISBbits.TRISB1)			
	#define	DATA0			(PORTBbits.RB1)

	#define DATA1_TRIS		(TRISBbits.TRISB2)			
	#define	DATA1			(PORTBbits.RB2)

	#define SENSOR1_TRIS	(TRISBbits.TRISB3)			
	#define	SENSOR1			(PORTBbits.RB3)

	#define RTE1_TRIS		(TRISEbits.TRISE1)			
	#define	RTE1			(PORTEbits.RE1)

	#define RELAY 			(PRODL)//(LED2_IO)
