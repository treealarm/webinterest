...
//static BYTE ServerName[] =	"192.168.0.103";
...
void GenericTCPClient(void)
{
	...
	switch(GenericTCPExampleState)
	{
		case SM_HOME:
			...
			ServerPort = atoi(AutonomSettings.data[E_PORT_CL]);
			MySocket = TCPOpen((DWORD)&AutonomSettings.data[E_HOST_CL][0], TCP_OPEN_RAM_HOST, ServerPort, TCP_PURPOSE_GENERIC_TCP_CLIENT);
		...
		case SM_SOCKET_OBTAINED:
			...
			TCPPutString(MySocket,AutonomSettings.data[E_HOST_CL]);
